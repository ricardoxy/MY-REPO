...
void OSC_freq (void)
{
  ...
  //  OSCCONbits.IDLEN = 0;       // Bit 7
    ...
    OSCCONbits.IRCF2 = 0;       // Bit 6 (HFINTOSC 16MHz  drives clock directly)
...
void interrups_initial(void)
{
 ...
 //   RCONbits.IPEN = 0;          // Bit 7 pg 52
  ...
  //  INTCONbits.INT0IE = 0;      // Bit 4 INT0 External Interrupt Enable bit
 ...
 //   INTCONbits.INT0IF = 0;      // Bit 1 INT0 External Interrupt Flag bit
